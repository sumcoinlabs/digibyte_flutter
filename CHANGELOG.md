...
- Added quick links to X, Youtube and email us on home screen.

### **0.1.1** (2024-12-18)

- Even more pricing updates with added decimals
- Better UI for more space between objects
- Time stamps for when price was last checked for possible update
- Number format improvements
- Transactions list to the thousands place

### **0.1.0** (2024-11-23)

- iOS 18 improvements
- More precise pricing with added decimals
- Better UI for more space between objects
...
- Dependency upgrades, e. g. now using Digicoinlib 0.0.2
...
- Change the options for purchasing DigiByte on some devices
...
- This app now uses Digicoinlib to deal with the hard stuff behind the scenes.
...
- Update DigiByte Wallet Developers address
...
- DigiByte v0.11 hard fork preperation (Nov 1st 2021)
