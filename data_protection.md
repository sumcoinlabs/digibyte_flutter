...
Thank you for using digibyte-flutter.
...
The data shared is essentially the same, as if you would use a digibyte full node.
...
The price ticker for DGB and FIAT exchange rates can be enabled or disabled optionally during setup or in "App Settings."
