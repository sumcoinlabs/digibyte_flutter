...
class _AboutScreenState extends State<AboutScreen> {
  ...
  Future<void> launchMailto() async {
    final mailtoLink = Mailto(
      to: ['digibytewalletorg@gmail.com'],
      subject: 'DigiByte Wallet - in app mail',
    );
                ...
                child: PeerContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!kIsWeb)
                        _listOfAvailableWallets.contains('digibyte') &&
                                !Platform.isIOS
                            ? TextButton(
                                onPressed: () async {
                                  ...
                                  final dgbWallet = values.firstWhere(
                                    (element) => element.name == 'digibyte',
                                  );
                                  ...
                                  navigator.pushNamed(
                                    ...
                                    arguments: {
                                      'wallet': dgbWallet,
                                      'pushedAddress':
                                          'D6e83goQvxoNTdgE232CbnpSrH1i6XUB7j',
                                    },
                                  );
                                },
                                child: Text(
                      ...
                      TextButton(
                        onPressed: () async => _launchURL(
                          'https://weblate.digibytewallet.org',
                        ),
                        child: Text(
                          AppLocalizations.instance.translate(
                            'about_go_weblate',
