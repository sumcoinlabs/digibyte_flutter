...
import 'package:digibyte/data_sources/electrum_backend.dart';
import 'package:digibyte/providers/server_provider.dart';
import 'package:digibyte/screens/wallet/wallet_slice_migration.dart';
import 'package:digibyte/screens/wallet/wallet_sign_transaction.dart';
import 'package:digibyte/widgets/wallet/address_book/addresses_tab_watch_only.dart';
import 'package:digibyte/widgets/wallet/wallet_home/wallet_delete_watch_only_bottom_sheet.dart';
import 'package:digibyte/widgets/wallet/wallet_home/wallet_hide_bottom_sheet.dart';
import 'package:digibyte/widgets/wallet/wallet_home/wallet_reset_bottom_sheet.dart';
...
class _WalletHomeState extends State<WalletHomeScreen>
  ...
  Future<void> _checkOpenRepliesEmptyLongerThanFiveSeconds() async {
    ...
    while (!isEmptyForFiveSeconds) {
      if (_connectionProvider.openReplies.isEmpty) {
        ...
        emptyDuration = const Duration(seconds: 0);
        await Future.delayed(const Duration(seconds: 1));
      }
    }
  }
  ...
  void didChangeDependencies() async {
    if (_initial == true) {
      ...
      // Start periodic updates for prices after initial setup
      PriceTicker.startPeriodicUpdates(_appSettings);
    } else {
          ...
          await showDialog(
            ...
            builder: (_) => AlertDialog(
              ...
              actions: <Widget>[
                TextButton.icon(
                  label: Text(
                    AppLocalizations.instance.translate('not_again'),
                  ),
  ...
  Future<void> _titleEditDialog(
    ...
    return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text(
            AppLocalizations.instance.translate('wallet_title_edit'),
            ...
            return [
              ...
              PopupMenuItem(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    AppLocalizations.instance.translate('delete_wallet'),
                  ),
                ),
              ),
            ];
          ...
          return [
            ...
            PopupMenuItem(
              ...
              child: ListTile(
                ...
                title: Text(
                  AppLocalizations.instance
                      .translate('wallet_pop_menu_signing_transactions'),
                ),
              ),
            ),
            PopupMenuItem(
          ...
          : Container(
              ...
              child: Column(
                children: [
                  ...
                  VisibilityDetector(
                    key: const Key('native ad detector'),
                    onVisibilityChanged: (VisibilityInfo info) {
                      if (info.visibleFraction == 1) {
