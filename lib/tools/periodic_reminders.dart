    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            /*
            // Uncomment the following section to enable donation reminders
            if (reminderItem.id == 'donate')
              TextButton(
                onPressed: () async {
                  final navigator = Navigator.of(context);
                  var url = 'https://www.digibytewallet.org/';
            ...
            if (reminderItem.id == 'donate' && !kIsWeb)
              listOfAvailableWallets.contains('digibyte') && !Platform.isIOS
                  ? TextButton(
                      onPressed: () async {
                        final navigator = Navigator.of(context);
